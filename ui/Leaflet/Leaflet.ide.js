TW.IDE.Widgets.Leaflet = function() {
	...
	this.widgetProperties = function() {
		return {
			name: "Leaflet",
			description: "Displays a Leaflet Map using the Coordinate Reference System for showing images that can be zoomed in/out and scrolled in the window",
			category: ["Data"],
			...
			properties: {
				...
				LayoutDimensions: {
					description: 'Original layout dimensions(or reference co-ordinates)of image: maximum height and maximum width as : "[height,width]"',
					isBindingTarget: true,
					isVisible: true,
					isEditable: true,
					baseType: "STRING",
				...
				OriginPoint: {
					description: 'Lower left co-ordinate of the image.Default is : "[x,y]=[0,0]"',
					isBindingTarget: true,
					isVisible: true,
					isEditable: true,
					baseType: "STRING",
				...
				AutoZoomBehavior: {
					...
					selectOptions: [{
						...
						text: "AutoZoom on data refresh, but disable AutoZoom if user manually pans or zooms",
					}, {
						value: "only-initial-data",
						text: "AutoZoom on initial data only (useful if you use BoundsChanged to retrieve new data)",
					}, ],
				},
				RadiusField: {
				...
				GeofenceTypeField: {
					description: "Field that will provide geofence type values(if more than one)",
					baseType: "FIELDNAME",
					sourcePropertyName: "Data",
					isBindingTarget: false,
				...
				GeofenceLabelField: {
					description: "Field which will provide label information for geofences",
					isBindingTarget: true,
					isVisible: true,
					isEditable: true,
					defaultValue: "",
